...
public class SendLogsToGoogleDriveActivity extends AppCompatActivity implements GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener,
    ...
    private final String KINOMETRIX_DIRECTORY_GOOGLEDRIVE_NAME = "Kinometrix";
    ...
    public boolean onPrepareOptionsMenu(Menu menu) {
        if (mGoogleApiClient != null && mGoogleApiClient.isConnected()) {
            menu.findItem(R.id.googleDriveItem).setTitle("Change Account");
        } else {
            menu.findItem(R.id.googleDriveItem).setTitle("Log In");
        }
